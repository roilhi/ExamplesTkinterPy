...
etiqueta1 = Label(root,text=" Escriba un número", bg="goldenrod3", bd=5)
etiqueta1.place(x=20, y=20)
entrada1 = Entry(root, bd=5, font="Helvetica 12")
...
boton1 = Button(root, text="Realizar operación", command = operacion)
